...
    // CHANGED: Default to an empty string instead of a placeholder URL
    avatar: '',
  });
...
          // CHANGED: Set avatar to the fetched profile image or an empty string if none exists
...
            {/* NEW: Conditional rendering for avatar */}
            {userData.avatar ? (
